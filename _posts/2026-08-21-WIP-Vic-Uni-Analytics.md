---
layout: post
title: Monitoring Student Outcomes at Victorian Universities 
image: "/posts/deakin-proj3.png"
tags: [Tableau, EDA, Data Viz, Python]
---

In this project we build a dashboard in Tableau using publically available education data to assess student outcomes across universities in Victoria, Australia, focussing on Deakin University.  
...
We aim to describe historic patterns and trends by bachelor student cohort: domestic or overseas, both pre and post Covid impact to Victoria, to identify any trends that may guide a deeper investigation.
...
We'll: 
* Retrieve institution and aggregate data from: The Australian Government Department of Education Higher Education's most recent [release](https://www.education.gov.au/higher-education-statistics/resources/2024-section-15-attrition-success-and-retention)
* Decide scope, evaluate data quality, and provide outcome definitions and caveats
...
* Arrange a dashboard and refine tooltips
* Provide key insights from this data for Deakin University: describing outcomes relative to other Victorian universities.

From the higher education statistics data, we isolate our individual institution rate measures for this analysis to Victorian education providers. We exclude any individual providers outside Victoria.

We compare these individual rates to average rates derived from:
...
These rates are published and have been calculated from government linked data: with StudentID linked to Commonwealth Higher Education Student Support Number (CHESSN) to track commencing student outcomes.
...
Deakin University shows steadily improving success rates across domestic and overseas student cohorts over time, indicating that for both cohorts, pass rates are rising in students' commencing year. 
In Deakin's domestic cohort, attrition rates reduced over the previous 10 years, consistent with leading Victorian providers. 
...
Deakin's overseas student attrition rate change pattern over this time is most similar to Federation University's during Victoria's Covid lockdown periods - though less extreme. 
...
These are laid out in tiles in a new dashboard sheet, giving us a view of outcomes and the option to select one or more instutions to view (A,S,R) trends and %-changes across the 10-year observed window.
...
Therefore, we might recommend closer inspection of both success and attrition in this overseas student cohort over the 2020-2022 years, to identify the main drivers for this concurrent rise in both attrition and success. 
...
This could lead to their attrition, and in that scenario, would account for the rise in both the attrition and success rate over this period in the broader overseas student cohort. 
...
These factors may be external, affecting some universities and not others. Monash and Melbourne, Victoria's leading providers in terms of success and attrition, do not display this pattern.
...
From this analysis, we might recommend that to gain deeper insights, particularly for the overseas student cohort we may:
* segment the overseas student population and gather more data on this cohort, and 
* consider further refinements to the statistical methodology used to measure attrition and success
